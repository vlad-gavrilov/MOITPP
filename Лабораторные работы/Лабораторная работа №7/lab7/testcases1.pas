...
begin
  ...
  AssertEquals('WRONG ERROR MESSAGE - ', 1, errorId);
end;

procedure TTestCases1.Test2;
begin
  Stats.CalcStats('t2.csv');
  AssertEquals('WRONG ERROR MESSAGE - ', 2, errorId);
end;
...
begin
  ...
  AssertEquals('WRONG ERROR MESSAGE 1 - ', 6, strToInt(strLine));

  readln(f, strLine);
  strLine := RightStr(strLine, 1);
  AssertEquals('WRONG ERROR MESSAGE 2 - ', 6, strToInt(strLine));
  ...
  readln(f, strLine);
  strLine := RightStr(strLine, 1);
  AssertEquals('WRONG ERROR MESSAGE 4 -3 ', 5, strToInt(strLine));

  readln(f, strLine);
  strLine := RightStr(strLine, 1);
  AssertEquals('WRONG ERROR MESSAGE 5 - ', 5, strToInt(strLine));
...
begin
  ...
  AssertEquals('WRONG ERROR MESSAGE - ', 4, errorId);
end;
